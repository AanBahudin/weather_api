...
export default function Home () {
  ...
  return (
    <div className='flex items-center w-full bg-[#5ab2f7] duration-300 dark:from-gray-800 dark:to-gray-900 flex-col justify-center text-3xl my-auto min-h-[100vh] h-fit'>
      <Search />
