...
export const informationSec = ['gust_kph', 'wind_dir', 'wind_kph', 'wind_degree']
export const informationDescSec = ['Gust', 'Direction', 'Wind', 'Degree']
export const informationUnitSec = ['km/h', '', 'km/h', '°']
