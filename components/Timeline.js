                ...
                return (
                    <li key={index} className="relative mb-6 sm:mb-0">
                        <div className="flex items-center">
                            <div className="flex z-10 justify-between items-center w-6 h-6 rounded-full bg-white dark:text-[#BFBFBF] shrink-0">
                            ...
                            <div className="hidden sm:flex w-52 bg-gray-700 dark:text-[#BFBFBF] h-0.5"></div>
                        </div>
                        <div className="mt-3 sm:pr-16">
                            <h3 className="flex items-center mb-1 text-sky-800 dark:text-[#BFBFBF] text-lg font-kanit">{item}</h3>
                            <h3 className="block mb-2 text-sm font-normal leading-none text-[#575757]">{data[item]}</h3>
                        </div>
                    </li>
                )
            })}
...
export default Timeline
        ...
        //                 <time className="block mb-2 text-sm font-normal leading-none text-[#575757]">{data[item]}</time>
        //             </li>
