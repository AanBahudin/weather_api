...
const Timeline = ({}) => {
    ...
    return (
        <ol data-aos="fade" className="items-center mx-auto w-full sm:flex md:my-0 my-6">
                ...
                return (
                    <li key={index} className="relative mb-6 sm:mb-0">
                        <div className="flex items-center">
                            ...
                            <div className="hidden sm:flex w-36 md:w-52 bg-gray-700 dark:text-silver h-0.5"></div>
                        </div>
