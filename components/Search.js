...
const Search = () => {
    ...
    return (
        <section className="w-full text-center relative text-white dark:text-silver"> 
            <h1 className="font-kanit duration-200 my-[2%]">Forecast WebApp</h1>

            <div className='flex mx-auto justify-center'>
                <input value={searchValue} onChange={e => handleSearch(e.target.value)} type='text' placeholder="Search ..." className="text-sans font-dosis text-center w-[40%] rounded-lg bg-transparent dark:placeholder:text-silver placeholder:text-white border-[1px] border-white/80  py-2 px-4 ring-0 outline-none" />
