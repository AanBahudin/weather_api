...
const Search = () => {
    ...
    const {allWeather, loading, debounceHandler, searchValue, handleSearch} = useWeatherContext()
    ...
    return (
        <section className="w-full text-center h-fit">
            ...
            {searchValue.length >= 3 ? (
                <div className='w-[40%] mt-4 transition-shadow duration-200 bg-transparent border-x-2 p-6 border-2 border-white mx-auto h-[40vh] rounded-md overflow-y-auto'>
