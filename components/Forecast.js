...
const Forecast = () => {
    ...
    return (
        <section className="mt-20 w-[80%] mx-auto grid auto-cols-auto auto-rows-auto gap-8 text-[1.1rem]">
            ...
            <div data-aos="fade-up" className="row-start-1 row-end-3 col-start-1 col-end-6 grid grid-cols-2 rounded backdrop-blur-3xl bg-white/[20%] dark:bg-cardDark duration-200">
