    ...
    return (
        <section className="font-kanit place-items-center">
            <article className=" grid  auto-rows-auto auto-cols-auto gap-8">
                ...
                <div className="grid row-start-1 row-end-6 col-start-1 col-end-6 rounded-xl border-white border-[2px]">
                    <article data-aos="fade-up" className="flex flex-col justify-center items-center p-7">
                        ...
                        <img className="w-40 animate-pulse mt-6" src={icon} alt="icons" />
                ...
                <section className="grid grid-cols-2 row-start-1 gap-8 row-end-3 col-start-6 col-end-12">
                    <div className="border-white rounded-xl border-[2px]">
                ...
                <section className="grid grid-cols-2 row-start-3 gap-8 row-end-6 col-start-6 col-end-12">
                    <div className="border-white rounded-xl border-[2px]">
                        <section className="text-[1.2rem] mt-[3]">
                            {Object.keys(data).filter(item => {
