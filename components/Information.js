    ...
    return (
        <section className="font-kanit place-items-center">
            <article className=" grid  auto-rows-auto auto-cols-auto gap-8">
                ...
                <div className="grid row-start-1 row-end-6 col-start-1 col-end-2 rounded-xl border-white border-[1px]">
                ...
                <section className="grid grid-cols-3 row-start-1 gap-8 row-end-3 col-start-2 col-end-8">
                    ...
                    <div className="border-white rounded-xl p-7 flex flex-col justify-center border-[1px]">
                            <h1 className="text-[1.6rem] font-semibold mb-4 text-center text-purple-400">Weather Information</h1>
                    ...
                    <div className="border-white rounded-xl p-7 flex flex-col justify-center border-[1px]">
                        <h1 className="text-[1.6rem] font-semibold mb-4 text-center text-purple-400">Air Quality</h1>
...
//   <div className="border-white text-[1.2rem] roborder-white rounded-xl p-7 flex flex-col justify-center border-[1px]">
//         <h1 className="text-[1.6rem] font-semibold mb-4 text-center text-purple-400">Location</h1>
//         <h1>{localtime.split(' ')[1]}</h1>
//         <h1>{moment(localtime.split(' ')[0]).format('l')}</h1>
//         <h1>{tz_id}</h1>
//         <h1>{lat}, {lon}</h1>
